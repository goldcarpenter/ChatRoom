...
<body  onload="startWebSocket(self);">      <%--body 加载完毕后触发一个方法 startWebSocket--%>
        ...
        <div class="abs cover pnl-body" id="pnlBody">
            <div class="abs cover pnl-left">
                ...
                <div class="abs bottom pnl-text">
                    ...
                    <div class="pnl-support" id="copyright"><a href="http://www.itcast.cn">掘金木匠,版本所有</a></div>
                </div>
            </div>
