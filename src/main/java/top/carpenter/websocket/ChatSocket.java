...
import top.carpenter.util.MessageUtil;
...
public class ChatSocket {
    ...
    private  Session session;           // WebSocket会话对象
    private  HttpSession httpSession;   // Servlet中的HttpSession
    ...
    @OnOpen
    //当开启一个新的会话时调用，该方法是客户端与服务端据手成功后调用的方法
